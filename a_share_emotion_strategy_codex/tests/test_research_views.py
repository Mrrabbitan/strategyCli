...
class ViewTests(unittest.TestCase):
    ...
    def test_nine_navigation_entries_and_unique_ids(self):
        ...
        self.assertEqual(p.nav,['hot','dragon','yichujifa','prelaunch','late-day','three-step','sector-radar','strategy','reports'])
