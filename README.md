...
[![Skill](https://img.shields.io/badge/Skill-autostrategy-blue)](https://github.com/anzp/autostrategy)
...
| 市场 | 数据源 | 交易规则 | 推荐入口 |
|------|--------|---------|---------|
| **A股个股** | [FTShare](https://github.com/anzp/all-in-one)（免费） | T+1，涨跌停 ±10%/±20% | 主 SKILL |
...
```bash
npx skills add anzp/autostrategy --yes
```
...
- **A股数据**：安装 [ftshare-all-in-one](https://github.com/anzp/all-in-one) Skill（免费）
...
- **语言**：Python 3.9+
- **数据处理**：NumPy, Pandas
- **数据源**：[FTShare](https://github.com/anzp/all-in-one)（A股 / A股 ETF）、akshare（A股 ETF 备选）、FutuAPI（港美股）
- **AI Agent 兼容**：Claude Code, Gemini CLI, Copilot CLI, Codex, Cline 等

## 相关项目

- [all-in-one](https://github.com/anzp/all-in-one) — 免费的 A 股/港股行情数据 Skill
